...
def main():
    ...
    data_loader = dataloader.Motion_DataLoader(
                        ...
                        train_ucf_list ='/home/lili/Video/datasets/HMDB51_concise/list/',
                        test_ucf_list = '/ubc/cs/research/tracking-raid/candice/datasets/HMDB51/list/new_test_flow.list',
                        ucf_split='01',
                        in_channel=10,
                        )
...
class Motion_CNN():
    ...
    def build_model(self):
        ...
        #build model
        self.model = resnet50(pretrained=True, channel=self.channel, num_classes = arg.num_classes).cuda()
        #print self.model
